...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredWithExcess(List<Meal> meals, Predicate<Meal> predicate) {
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
        ...
        return meals.stream()
                .filter(predicate)
                .map(meal -> createWithExcess(meal, caloriesSumByDate.get(meal.getDate()) > MealData.DEFAULT_CALORIES))
